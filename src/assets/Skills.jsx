...
import NextJs from "../logo skill/nextjs.png";
import Tailwind from "../logo skill/tailwindcss.svg";
import Riek from "../logo skill/reactjs.png";
import Git from "../logo skill/git.svg";
import Sass from "../logo skill/sass.png";
import Jquery from "../logo skill/jquery.png";
...
const Skills = [
  ...
  { name: "Next js", logo: NextJs, level: "Beginner" },
  { name: "Jquery", logo: Jquery, level: "Beginner" },
